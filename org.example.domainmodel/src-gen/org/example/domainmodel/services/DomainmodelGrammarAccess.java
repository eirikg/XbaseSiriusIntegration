...
public class DomainmodelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DomainmodelElements extends AbstractParserRuleElementFinder {
		...
		//{Domainmodel} importSection=XImportSection? elements+=AbstractElement*
	...
	public class PropertyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.domainmodel.Domainmodel.Property");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.domainmodel.Domainmodel.Operation");
		private final Group cGroup = (Group)rule.eContents().get(1);
